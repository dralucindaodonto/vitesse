...
<template>
    ...
    <div class="flex flex-no-wrap">
      ...
      <div class="w-76 absolute sm:relative   md:h-full flex-col justify-between hidden sm:flex  border-r-1 border-gray border-op-20">
        <div class="px-8 pt-14">
          ...
          <ul class="mt-12 ml-10">
            <li class="flex w-full justify-between dark:text-gray-200 hover:text-gray-500 cursor-pointer items-center mb-6">
              <RouterLink to="/patients/1/anamnese">
                <div class="flex items-center">
                  ...
                  <span class="text-sm ml-2">Anamnese</span>
                </div>
              </RouterLink>
            </li>
            <li class="flex w-full justify-between dark:text-gray-200 hover:text-gray-500 cursor-pointer items-center mb-6">
            ...
            <li class="flex w-full justify-between dark:text-gray-200 hover:text-gray-500 cursor-pointer items-center">
              <div class="flex items-center">
        ...
        <div class="pa-8 ">
          <ul class="w-full flex items-center justify-between ">
            <li class="cursor-pointer  dark:text-gray-200 pt-5 pb-3">
      ...
      <!-- <div id="mobile-nav" class="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out">
      ...
      <div class="px-8">
        ...
        <ul class="mt-12">
          <li class="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
            ...
            <div class="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
              5
            </div>
          </li>
      ...
      <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
        ...
        <div class="w-full h-full rounded  border-1 border-gray border-op-20 dark:text-gray-200">
          <RouterView />
        </div>
      </div>
    </div>
  ...
  <!-- <div class="text-center text-gray-700 dark:text-gray-200">
    ...
    <div class="flex-1 flex-row">
      <div class="w-80 h-full shadow-md   pl-6 absolute">
        <ul mt-25>
          <li>
            <RouterLink to="/patients/1/anamnese">
              <span rounded hover:text-gray-900 hover:bg-blue-500 hover:bg-op-70 px-25 py-5>  Anamnese</span>
            </RouterLink>
          </li>
        </ul>
      </div>
